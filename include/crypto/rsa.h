...
RSA *rsa_new_with_ctx(OSSL_LIB_CTX *libctx);
OSSL_LIB_CTX *rsa_get0_libctx(RSA *r);
...
int rsa_padding_check_PKCS1_type_2_TLS(OSSL_LIB_CTX *ctx, unsigned char *to,
                                       size_t tlen, const unsigned char *from,
                                       size_t flen, int client_version,
                                       int alt_version);
int rsa_padding_add_PKCS1_OAEP_mgf1_with_libctx(OSSL_LIB_CTX *libctx,
