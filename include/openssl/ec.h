 ...
 */
EC_GROUP *EC_GROUP_new_by_curve_name_with_libctx(OSSL_LIB_CTX *libctx,
 ...
 */
EC_KEY *EC_KEY_new_with_libctx(OSSL_LIB_CTX *ctx, const char *propq);
 ...
 *  \return EC_KEY object or NULL if an error occurred.
 */
EC_KEY *EC_KEY_new_by_curve_name_with_libctx(OSSL_LIB_CTX *ctx, const char *propq,
                                             int nid);
