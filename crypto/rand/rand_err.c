...
static const ERR_STRING_DATA RAND_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, RAND_F_RAND_DRBG_ADD, 0), "rand_drbg_add"},
...
static const ERR_STRING_DATA RAND_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_RAND, 0, RAND_R_SIZE_OUT_OF_RANGE), "size out of range"},
