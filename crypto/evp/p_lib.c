...
EVP_PKEY *EVP_PKEY_new_raw_private_key_with_libctx(OSSL_LIB_CTX *libctx,
                                                   const char *keytype,
                                                   const char *propq,
...
EVP_PKEY *EVP_PKEY_new_raw_public_key_with_libctx(OSSL_LIB_CTX *libctx,
                                                  const char *keytype,
                                                  const char *propq,
...
int evp_pkey_downgrade(EVP_PKEY *pk)
{
    ...
    if (EVP_PKEY_set_type(pk, type)) {
        ...
        if (pk->ameth->import_from == NULL) {
             ...
             * are using.
             */
            OSSL_LIB_CTX *libctx = ossl_provider_library_context(keymgmt->prov);
