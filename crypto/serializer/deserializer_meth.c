...
static void *deserializer_store_new(OSSL_LIB_CTX *ctx)
{
    return ossl_method_store_new(ctx);
}


static const OSSL_LIB_CTX_METHOD deserializer_store_method = {
...
static void *alloc_tmp_deserializer_store(OSSL_LIB_CTX *ctx)
{
    return ossl_method_store_new(ctx);
}
...
static void *get_deserializer_from_store(OSSL_LIB_CTX *libctx, void *store,
                                         void *data)
{
...
static int put_deserializer_in_store(OSSL_LIB_CTX *libctx, void *store,
...
static OSSL_DESERIALIZER *inner_ossl_deserializer_fetch(OSSL_LIB_CTX *libctx,
                                                        int id,
                                                        const char *name,
...
OSSL_DESERIALIZER *OSSL_DESERIALIZER_fetch(OSSL_LIB_CTX *libctx,
                                           const char *name,
                                           const char *properties)
{
...
OSSL_DESERIALIZER *ossl_deserializer_fetch_by_number(OSSL_LIB_CTX *libctx,
                                                     int id,
                                                     const char *properties)
{
...
int OSSL_DESERIALIZER_is_a(const OSSL_DESERIALIZER *deser, const char *name)
{
    if (deser->base.prov != NULL) {
        OSSL_LIB_CTX *libctx = ossl_provider_library_context(deser->base.prov);
        OSSL_NAMEMAP *namemap = ossl_namemap_stored(libctx);
...
void OSSL_DESERIALIZER_do_all_provided(OSSL_LIB_CTX *libctx,
