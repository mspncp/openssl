...
s/([ !])HEADER_INTERNAL_AES_PLATFORM_H/\1OSSL_CRYPTO_AES_PLATFORM_H/g ;
...
s/([ !])HEADER_BLAKE2_H/\1OSSL_INTERNAL_BLAKE2_H/g ;
...
s/([ !])OSSL_CORE_MKDIGEST_H/\1OSSL_PROVIDERS_CORE_MKDIGEST_H/g ;
