...
s/([ !])HEADER_AES_LOCL_H/\1OSSL_CRYPTO_AES_AES_LOCAL_H/g ;
s/([ !])__ARM_ARCH_H__/\1OSSL_CRYPTO_ARM_ARCH_H/g ;
s/([ !])OPENSSL_ASYNC_ARCH_ASYNC_POSIX_H/\1OSSL_CRYPTO_ASYNC_ARCH_ASYNC_POSIX_H/g ;
s/([ !])HEADER_BF_LOCL_H/\1OSSL_CRYPTO_BF_BF_LOCAL_H/g ;
s/([ !])HEADER_BN_LCL_H/\1OSSL_CRYPTO_BN_BN_LOCAL_H/g ;
s/([ !])RSAZ_EXP_H/\1OSSL_CRYPTO_BN_RSAZ_EXP_H/g ;
s/([ !])HEADER_CAMELLIA_LOCL_H/\1OSSL_CRYPTO_CAMELLIA_CMLL_LOCAL_H/g ;
s/([ !])OSSL_HEADER_CMP_INT_H/\1OSSL_CRYPTO_CMP_CMP_LOCAL_H/g ;
s/([ !])HEADER_CMS_LCL_H/\1OSSL_CRYPTO_CMS_CMS_LOCAL_H/g ;
s/([ !])OSSL_HEADER_CRMF_INT_H/\1OSSL_CRYPTO_CRMF_CRMF_LOCAL_H/g ;
s/([ !])HEADER_DES_LOCL_H/\1OSSL_CRYPTO_DES_DES_LOCAL_H/g ;
s/([ !])HEADER_ARCH_32_ARCH_INTRINSICS_H/\1OSSL_CRYPTO_EC_ARCH_32_ARCH_INTRINSICS_H/g ;
s/([ !])HEADER_ARCH_32_F_IMPL_H/\1OSSL_CRYPTO_EC_ARCH_32_F_IMPL_H/g ;
s/([ !])HEADER_CURVE448_LCL_H/\1OSSL_CRYPTO_EC_CURVE448_LOCAL_H/g ;
s/([ !])HEADER_CURVE448UTILS_H/\1OSSL_CRYPTO_EC_CURVE448UTILS_H/g ;
s/([ !])HEADER_ED448_H/\1OSSL_CRYPTO_EC_ED448_H/g ;
s/([ !])HEADER_FIELD_H/\1OSSL_CRYPTO_EC_FIELD_H/g ;
s/([ !])HEADER_POINT_448_H/\1OSSL_CRYPTO_EC_POINT_448_H/g ;
s/([ !])HEADER_WORD_H/\1OSSL_CRYPTO_EC_WORD_H/g ;
s/([ !])HEADER_ENGINE_INT_H/\1OSSL_CRYPTO_ENGINE_ENG_LOCAL_H/g ;
s/([ !])HEADER_HMAC_LCL_H/\1OSSL_CRYPTO_HMAC_HMAC_LOCAL_H/g ;
s/([ !])__MIPS_ARCH_H__/\1OSSL_CRYPTO_MIPS_ARCH_H/g ;
s/([ !])HEADER_PPC_ARCH_H/\1OSSL_CRYPTO_PPC_ARCH_H/g ;
s/([ !])HEADER_RAND_LCL_H/\1OSSL_CRYPTO_RAND_RAND_LOCAL_H/g ;
s/([ !])HEADER_RC4_LOCL_H/\1OSSL_CRYPTO_RC4_RC4_LOCAL_H/g ;
s/([ !])RSA_LOCAL_HEADER_H/\1OSSL_CRYPTO_RSA_RSA_LOCAL_H/g ;
s/([ !])S390X_ARCH_H/\1OSSL_CRYPTO_S390X_ARCH_H/g ;
s/([ !])HEADER_SEED_LOCL_H/\1OSSL_CRYPTO_SEED_SEED_LOCAL_H/g ;
s/([ !])__SPARC_ARCH_H__/\1OSSL_CRYPTO_SPARC_ARCH_H/g ;
s/([ !])HEADER_UI_LOCL_H/\1OSSL_CRYPTO_UI_UI_LOCAL_H/g ;
...
s/([ !])HEADER_SSL_LOCL_H/\1OSSL_SSL_OSSL_SSL_LOCAL_H/g ;
s/([ !])DRBG_CAVS_DATA_H/\1OSSL_TEST_DRBG_CAVS_DATA_H/g ;
s/([ !])ECDSATEST_CAVS_H/\1OSSL_TEST_ECDSAOSSL_TEST_H/g ;
...
s/([ !])HEADER_INTERNAL_ENDIAN_H/\1OSSL_TEST_OSSL_OSSL_TEST_ENDIAN_H/g ;
s/([ !])HEADER_SSL_TEST_CTX_H/\1OSSL_TEST_SSL_OSSL_TEST_CTX_H/g ;
s/([ !])HEADER_SSLTESTLIB_H/\1OSSL_TEST_SSLTESTLIB_H/g ;
s/([ !])HEADER_TESTUTIL_H/\1OSSL_TEST_TESTUTIL_H/g ;
s/([ !])HEADER_TU_OUTPUT_H/\1OSSL_TEST_TESTUTIL_OUTPUT_H/g ;
